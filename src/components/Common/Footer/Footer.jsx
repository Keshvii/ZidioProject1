      ...
      <Container>
        <Row>
          ...
          <div className="d-flex align-items-center">
            ...
            <p className="pb-2"> Bengaluru, Karnataka, India</p>
          </div>

          <div className="d-flex align-items-top my-2">
          <i className="bi bi-envelope me-3"></i>
          <a target="_blank"className="d-block" >support@zidio.in</a>
          </div>
          <div className="d-flex align-items-top ">
          <i className="bi bi-telephone me-3"></i>
          <a target="_blank" href="tel:1234567890" className="d-block" >1234567890</a>
          </div>
        ...
        <p className="text-light">   @ 2024. Zidio Development. All rights reserved </p> 
        </Col>
        </Row>
